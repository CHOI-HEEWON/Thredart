...
class KrHexAPI(Bot):
    def __init__ (self, server=None):
        ...
        config.MUTE = True
        self.krHexDBConnAPI = KrHexDBConnAPI.KrHexDBConnAPI()   
        self.acc = None
    ...
    def kr_hex_buy(self):      
        ...
        ticker, d_2_v, d_1_v, d0_v, d0_high_price = self.krHexDBConnAPI.select_kr_hex_ticker()
...
class MyServer(Server):
    ...
    def opt10080(self, scr_no, rq_name, tr_code, record_name, prev_next):
        ...
        file_name = f'kr_stock_hex_0.28_intraday_1hour_{str(ticker)}_data.xlsx'
