...
class DexKiwoomAPI(Bot):
    ...
    def opt10080(self, rq_name='opt10080', tr_code='opt10080', prev_next='0', scr_no='0101'):
        ...
        ticker_list = ['093230', '093640', '096610', '101000', '101240', '114190', '117730', '131400', '145210', '152550', '204630', '208370', '229000', '234920', '246720', '270520', '282720', '290690', '298060', '317770', '389140', '402030', '417860', '900250', '900300']
...
class MyServer(Server):
    ...
    def opt10080(self, scr_no, rq_name, tr_code, record_name, prev_next):
        ...
        # ticker = data['종목코드'][0]
        # data = pd.DataFrame(data)
        # file_name = f'{str(ticker)}.xlsx'
        # data.to_excel('C:/Users/Choi Heewon/thredart/dex/one_hour_candle_data/'+file_name)            
